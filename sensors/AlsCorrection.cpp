...
#define PROCALS_PATH "/proc/sensor/als_cali/"
...
static const std::string rgbw_max_lux_paths[4] = {
    PROCALS_PATH "red_max_lux",
    PROCALS_PATH "green_max_lux",
    PROCALS_PATH "blue_max_lux",
...
void AlsCorrection::init() {
    ...
    float screen_on_time = get(PROCALS_PATH "screenontimebyhours", 0.0);
    ...
    float als_bias = get(PROCALS_PATH "als_bias", 0.0);
    ...
    if(DEBUG) ALOGI("Max brightness: %.0f", conf.max_brightness);
